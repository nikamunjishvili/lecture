...
// const box_1 = createBoxItem("darkred");
// const box_2 = createBoxItem("darkgreen");
// const box_3 = createBoxItem("black");

// createTextItem("box_1", "black", box_1);
// createTextItem("box_2", "darkred", box_2);
// createTextItem("box_3", "white", box_3);

// createButton("Click_me", "black", box_1);
// createButton("Submit", "darkred", box_2);
// createButton("Click", "black", box_3);

// app.appendChild(box_1);
// app.appendChild(box_2);
// app.appendChild(box_3);
...
//   const lastName = document.getElementById("lastName").value;
//   try {
//     const response = await fetch("http://localhost:3000/log-name-surname", {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
//       },
